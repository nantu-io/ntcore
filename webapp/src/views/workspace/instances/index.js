...
import { fetchDataV1, postDataV1 } from '../../../global';
...
class Instances extends React.Component {
  ...
  _onOpenClick = (type, name) => {
    var link;
    switch (type) {
      case ServiceType.THEIA_PYTHON: link = `/i/${name}/#/home/project/${this.props.workspaceId}`; break;
      case ServiceType.JUPYTER: link = `/i/${name}`; break;
      default: link = `/i/${name}`; break;
    }
    postDataV1(`/dsp/api/v1/service/${name}/workspace/${this.props.workspaceId}`)
